...
const summe = (zahl1, zahl2) => console.log(zahl1 + zahl2)

const produkt = (zahl1, zahl2) => console.log(zahl1 * zahl2)

let erg = 0;
const factorial = (n) => {
    console.log(n ? n * factorial(n - 1) : 1);
}

const student = {"name": "Klaus", "id": 1}
console.log(student)
...
const studentChange = () => {
    const index = studentArray.findIndex(s => s.name == 'Udo')
    console.log(studentArray[index])
    studentArray[index].name = "Otto"
    console.log(studentArray[index])
}


const studentChange1 = () => {
    const arrayNeu = studentArray
    console.log(arrayNeu[2])
    arrayNeu[2].name = "Ursula"
...
const getAllNames = rickMorty.map(rickMorty => (
    {
        name: rickMorty.name,
        origin: rickMorty.origin.name
    }
))

console.log(getAllNames)
function getStatus(){
    const alive = rickMorty.filter(rickMorty => rickMorty.status === "Alive")
    console.log(alive[0])
}
